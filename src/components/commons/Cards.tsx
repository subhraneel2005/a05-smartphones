...
export default function Cards({ name,  description, logo}: Card) {
  ...
  return (
    <div className="w-[350px] md:h-[400px] h-[200px] flex flex-col justify-start items-start px-6 mt-10">
        ...
        <p className="text-desktop/body/2/regular md:text-desktop/body/1 max-w-[350px] mt-2">{description}</p>
    </div>
  )
}
