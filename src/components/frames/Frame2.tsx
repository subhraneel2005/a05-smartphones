...
export default function Frame2() {
  return (
    <div className="relative mt-[16px] bg-[#FCCE8D] bg-opacity-[20%] border border-[#FCCE8D] w-full h-full min-h-[400px] md:h-screen flex flex-col items-center md:rounded-[36px] rounded-[16px]">
    {/* text div */}
