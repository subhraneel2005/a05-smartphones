  ...
  return (
    <div className='relative min-h-screen w-full bg-[#fff] overflow-hidden'>
      ...
      <div className='relative z-10 flex flex-col md:flex-row justify-between items-center h-full w-full'>
        <div className='flex-1 md:ml-28 ml-0 px-0 md:px-8 pt-12'>
        <div className='px-2 font-black rounded-[24px] border-2 border-black w-fit text-[14px] flex justify-center items-center'>
          <p className='mr-1'>AWESOME SERIES</p> {/* Add margin-right for spacing */}
          <svg className='mb-1' width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <h1 className="md:text-[9rem] text-[2.4rem] font-bold md:mt-10 mt-3">A05s</h1>
          <div className='flex flex-col text-[12px] md:text-[16px] text-gray-700 font-semibold'>
            <p className=''>8GB* 4GB+4GB* RAM + 64GB ROM | 6.6" HD+</p>
            <p className=''>Drop Notch Display | Type-C Charger</p>
          </div>
      ...
      {/* Footer */}
      <footer className="absolute md:ml-28 ml-0 bottom-0 px-0  w-full py-4">
        <p className="md:text-[16px] text-[12px] ml-2 text-gray-600">*Memory Fusion Technology</p>
      </footer>
    </div>
  );
}
