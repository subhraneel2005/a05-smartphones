export default function FourthPage() {
  return (
    <div className="min-h-screen w-full xxl:hidden px-[16px] md:px-[36px] flex flex-col justify-center items-center py-6">
      <div className="flex flex-col md:flex-row w-full h-[750px] gap-4">
        ...
        <p className="absolute md:top-16 top-6 mb-10 text-start md:text-desktop/h4 text-[16px] font-bold z-10">
          ...
          <img
            ...
            className="absolute bottom-0 flex justify-center items-center object-cover rounded-lg w-[45%] h-auto mx-auto"
          />
        </div>
        ...
        <div className="flex flex-col gap-4 flex-1 h-full">
          ...
          <div className="bg-custom-gradient relative flex flex-col justify-center items-center flex-grow min-h-[200px] md:min-h-[60%] rounded-lg border border-[#FCA74180]">
            <p className="absolute top-4 text-center md:text-desktop/h4 px-4 font-bold text-[16px] z-10">
          ...
          <div className="bg-custom-gradient relative flex flex-col justify-center items-center flex-grow min-h-[300px] md:min-h-[40%] rounded-lg border border-[#FCA74180]">
            ...
            <span className="pl-6 pb-16">
              <p className="md:text-desktop/h5 font-bold top-4 md:top-0 text-[16px] z-10">
                High-Performance 1.6 GHz Processor Clock Speed
              </p>
              <p className="md:text-desktop/h6 text-mobile/h6 mt-3 z-10 text-[#232323]">
