export default function FourthPage() {
    return (
      <div className="min-h-screen w-full flex flex-col justify-center items-center py-6">
        <div className="flex flex-col md:flex-row w-3/4 h-[750px] gap-4">
          {/* Left Block with image and text in column format */}
          <div className="bg-custom-gradient relative flex flex-col justify-center items-center flex-1 h-[80%] md:h-full rounded-lg border border-[#FCA74180] w-full p-2">
            <p className="absolute top-6 text-center md:text-desktop/h3 text-[16px] font-bold z-10">
              Enjoy High-Speed 4G Internet
            </p>
            <img
              src="/f5i1.png"
              alt="Background Image"
              className="absolute bottom-0 flex justify-center items-center object-cover rounded-lg w-[60%] h-auto mx-auto"
            />
          </div>
          ...
          <div className="flex flex-col gap-4 flex-1 h-full">
            ...
            <div className="bg-custom-gradient relative flex flex-col justify-center items-center flex-grow min-h-[150px] md:min-h-[60%] rounded-lg border border-[#FCA74180]">
